...
{
    public partial class view_semester_courses : System.Web.UI.Page
    {
        SqlConnection conn;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            conn.Open();
            daCourses = new SqlDataAdapter("SELECT course_code, course_title, credit_units, Status FROM tblsemester_courses WHERE semester='" + semester + "' AND + academic_session='" + academic_session + "'AND program='" + program + "'AND course_option='" + course_option + "' AND Dept='" + Dept + "'", conn);
