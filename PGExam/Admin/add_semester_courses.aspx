<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="add_semester_courses.aspx.cs" Inherits="DesignTemplate1.Admin.add_semester_courses1" %>
            ...
            <tr>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:Panel ID="Panel2" runat="server" BorderStyle="Solid" BorderWidth="2px" CssClass="panelWidth" Width="573px" BackColor="#CCCCCC">
                                <table class="tbl">
                                    <tr>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style8">
                                            <asp:DropDownList ID="ddlLsession" runat="server" Height="20px" AutoPostBack="True">
                                            </asp:DropDownList>
                                            &nbsp;<span class="auto-style27"><strong>/</strong></span>
                                            <asp:DropDownList ID="ddlUsession" runat="server" Height="20px" AutoPostBack="True">
                                            </asp:DropDownList>
                                        </td>
                                ...
                                <table class="auto-style23">
                                    ...
                                    <tr>
                                        <td class="auto-style1" colspan="2">
                                            ...
                                            <asp:Panel ID="Panel4" CssClass="Popup" runat="server" align="center" style = "display:none">
                                                <iframe style=" width: 100%; height: 100%;" id="irm1" Src="view_semester_courses.aspx" runat="server"></iframe>  
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style34">
                                            ...
                                            <asp:Button ID="btnView" runat="server" OnClick="btnView_Click" Text="View Uploaded Courses" />
                                            <cc1:ModalPopupExtender ID="mp1" BackgroundCssClass="Background" runat="server" PopupControlID="Panel4" TargetControlID="btnView" CancelControlID="Button2" X="800" Y="100" >  
