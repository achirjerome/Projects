<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="exam_compute.aspx.cs" Inherits="DesignTemplate1.Admin.exam_compute" %>
...
<table class="auto-style1">
    ...
    <tr>
        <td class="auto-style2">&nbsp;</td>
        <td class="auto-style4" style="width: 297px; color: #006600;"><strong>Compute Examination </strong></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td class="auto-style2">&nbsp;</td>
...
<div>
    <table class="auto-style1">
                            ...
                            <table class="auto-style1">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style25" style="width: 350px; height: 33px">
                                        <asp:DropDownList ID="ddlCourse_Option" runat="server"  Height="23px"  Width="250px">
                                        </asp:DropDownList>
                                    </td>
        ...
        <tr>
            ...
            <td class="auto-style22" style="width: 552px; height: 22px;">
                <asp:Label ID="lblmsg" runat="server" Font-Bold="False" ForeColor="#FF3300"></asp:Label>
            </td>
        ...
        <tr>
            <td class="auto-style13">&nbsp;</td>
            <td class="auto-style9" style="width: 552px">
                <asp:Button ID="btnCompute" runat="server" Font-Size="Medium" Height="31px" Text="Compute" Width="119px" OnClick="btnCompute_Click" />
            </td>
            <td style="width: 251px">&nbsp;</td>
        </tr>
        <tr>
            <td class="auto-style13">&nbsp;</td>
            <td class="auto-style9" style="width: 552px">&nbsp;</td>
            <td style="width: 251px">&nbsp;</td>
        </tr>
    </table>
    <hr />
