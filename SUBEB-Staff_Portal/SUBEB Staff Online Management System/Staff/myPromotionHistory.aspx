<%@ Page Title="" Language="C#" MasterPageFile="~/Staff/Staff.master" AutoEventWireup="true" CodeBehind="myPromotionHistory.aspx.cs" Inherits="SUBEB_Staff_Online_Management_System.Staff.myPromotionHistory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="nav-justified">
        ...
        <tr>
            ...
            <td style="width: 683px; font-size: large; height: 38px; background-color: #FFCCCC;"><strong>My Promotion History</strong></td>
