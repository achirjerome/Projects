...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style16" style="width: 1033px">
                ...
                <asp:Panel ID="Panel4" runat="server" BorderStyle="Solid" BorderWidth="2px" Width="661px">
                    <table class="style16">
                        ...
                        <tr>
                            <td style="width: 89px">&nbsp;</td>
                            <td>
                                <asp:Button ID="btnRetrieve" runat="server" Font-Bold="True" Height="34px" OnClick="btnRetrieve_Click" Text="Retrieve" Width="103px" />
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
        ...
        <tr>
            <td style="width: 84px">&nbsp;</td>
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" CellSpacing="6" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound">
                    <AlternatingRowStyle BackColor="#CCCCCC" />
                    <HeaderStyle BackColor="#669999" Font-Bold="True" />
                </asp:GridView>
            </td>
            <td style="width: 324px">&nbsp;</td>
        </tr>
