    ...
    public partial class RegApproval : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (DBLGA == true)
                {
                    hl.NavigateUrl = "~/StaffBio.aspx?id=" + dsApproval.Tables["lga"].Rows[e.Row.RowIndex]["staffNo"].ToString() + "&DB=1";
                    hl.Target = "_blank";
                }
                else
                {
                    hl.NavigateUrl = "~/StaffBio.aspx?id=" + dsApproval.Tables["hqtrs"].Rows[e.Row.RowIndex]["staffNo"].ToString() + "&DB=0";
                    hl.Target = "_blank";
