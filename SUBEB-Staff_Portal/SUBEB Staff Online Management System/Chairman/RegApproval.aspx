<%@ Page Title="" Language="C#" MasterPageFile="~/Chairman/Chairman.master" AutoEventWireup="true" CodeBehind="RegApproval.aspx.cs" Inherits="SUBEB_Staff_Online_Management_System.Chairman.RegApproval" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <table class="nav-justified">
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td class="text-center" style="font-size: medium; background-color: #FFCCCC"><em><strong>Registration Approval</strong></em></td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
