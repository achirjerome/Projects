...
namespace SUBEB_Staff_Online_Management_System.Chairman
{
    public partial class Scrutiny : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                string staffN= dsScrutiny.Tables["query"].Rows[e.Row.RowIndex]["staffNo"].ToString();
                string queryDate= dsScrutiny.Tables["query"].Rows[e.Row.RowIndex]["querydate"].ToString();
              
                var secondCell = e.Row.Cells[1];
                secondCell.Controls.Clear();
                HyperLink hl = new HyperLink();
                hl.Text = secondCell.Text;
                hl.NavigateUrl = "~/Chairman/ScrutinyLetters.aspx?id=" + staffN + "&queryDate=" + queryDate;
                hl.Target = "_blank";
