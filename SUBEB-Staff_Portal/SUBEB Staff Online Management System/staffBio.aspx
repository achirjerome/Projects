<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="staffBio.aspx.cs" Inherits="SUBEB_Staff_Online_Management_System.staffBio" %>
        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style6">&nbsp;</td>
                    <td class="auto-style4">
                        <asp:Image ID="Image1" runat="server" Height="123px" Width="127px" BorderStyle="Solid" />
                        <ajaxToolkit:DropShadowExtender ID="Image1_DropShadowExtender" runat="server" BehaviorID="Image1_DropShadowExtender" TargetControlID="Image1" />
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style4">
                        <asp:Panel ID="Panel1" runat="server" Width="559px">
                            <asp:FormView ID="FormView1" runat="server" AllowPaging="true" BorderStyle="Double" CellPadding="4" CellSpacing="4" GridLines="Horizontal" HeaderText="Bio Data" BorderWidth="2px">
                                <ItemTemplate>
                                    <table class="table-padding" border="1">
                                        <tr>
                                            <td>Staff No</td>
                                            <td><%#Eval("StaffNo") %></td>
                                        </tr>
