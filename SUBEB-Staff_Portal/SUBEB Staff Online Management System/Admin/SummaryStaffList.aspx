<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeBehind="SummaryStaffList.aspx.cs" Inherits="SUBEB_Staff_Online_Management_System.Admin.SummaryStaffList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                                    ...
                                                    <table class="style16">
                                                        <tr>
                                                            ...
                                                            <td style="height: 38px">
                                                                <asp:DropDownList ID="ddlLGEA" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlLGEA_SelectedIndexChanged" style="font-size: small">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" CellSpacing="4" OnRowDataBound="GridView1_RowDataBound">
                                                        ...
                                                        <HeaderStyle BackColor="#669999" BorderStyle="Solid" BorderWidth="2px" Font-Bold="True" />
                                                    </asp:GridView>
                                                </td>
                                                <td>&nbsp;</td>
                                            </tr>
    ...
    <tr>
        <td colspan="4" style="height: 78px">
            <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid" BorderWidth="2px" ScrollBars="Vertical" Width="1017px">
            </asp:Panel>
        </td>
    </tr>
    <tr>
