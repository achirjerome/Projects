<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeBehind="transfer.aspx.cs" Inherits="SUBEB_Staff_Online_Management_System.Admin.transfer" %>
    ...
    <table class="style16">
        ...
        <tr>
            <td style="width: 173px">
                &nbsp;</td>
            <td style="width: 725px">
                <asp:RadioButton ID="rbtLGEA" runat="server" Checked="True" GroupName="db" Text="LGEA" OnCheckedChanged="rbtLGEA_CheckedChanged" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:RadioButton ID="rbtHqtrs" runat="server" GroupName="db" Text="Hqtrs" OnCheckedChanged="rbtHqtrs_CheckedChanged" />
            </td>
            <td>
                &nbsp;</td>
        </tr>
                        ...
                        <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid" BorderWidth="2px" GroupingText="Staff Transfer">
                            <table class="style16" style="font-size: medium">
                                ...
                                <tr>
                                    ...
                                    <td style="height: 35px">
                                        <asp:DropDownList ID="ddlPosting" runat="server" Height="25px" style="font-size: medium" Width="290px">
                                        </asp:DropDownList>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:CheckBox ID="chkHqtrs" runat="server" style="font-size: small" Text="Hqtrs" />
                                    </td>
                                    <td style="height: 35px"></td>
                                </tr>
                                <tr>
