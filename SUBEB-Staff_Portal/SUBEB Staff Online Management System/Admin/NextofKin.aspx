<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeBehind="NextofKin.aspx.cs" Inherits="SUBEB_Staff_Online_Management_System.Admin.NextofKin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td style="width: 530px; color: #006600; background-color: #FFCCFF; text-align: center; height: 35px;">
                <strong>NEXT OF KIN BIODATA FORM</strong></td>
            ...
            <td style="width: 530px">
                ...
                BorderWidth="2px" style="text-align: left" Width="520px">
                    <table class="style4" style="color: #333333; width: 509px">
                        <tr>
                            <td class="style26" style="width: 29px">
                            &nbsp;</td>
                            <td class="style46" style="width: 146px; font-size: medium;">
                            &nbsp;</td>
                        ...
                        <tr>
                            <td class="style27" style="width: 29px; height: 19px;">
                                </td>
                            <td class="style46" style="width: 146px; height: 19px; font-size: medium;">
                                </td>
                            <td class="style45" style="width: 255px; height: 19px;">
                                </td>
                        ...
                        <tr>
                            <td class="style27" style="width: 29px; height: 34px;">
                            &nbsp;</td>
                            <td class="style46" style="width: 146px; height: 34px; font-size: medium;">
                            Middle Name</td>
                            <td class="style45" style="width: 255px; height: 34px;">
